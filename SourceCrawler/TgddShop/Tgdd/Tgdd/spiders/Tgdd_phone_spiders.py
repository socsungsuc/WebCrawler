...
# baseUrl = 'https://www.thegioididong.com/dtdd'
# tailUrl = [
#     '#c=42&o=17&pi=5',
# ]
...
# class TGDD_Phone_Spider(scrapy.Spider):
#     name = 'tgdd-phone'
...
#         image_urls = ('https://cdn.tgdd.vn/Products/Images/42/251192/iphone-14-pro-max-den-thumb-600x600.jpg')
...
#         product_disk = response.css('body > section.detail > div.box_main > div.box_right > div.parameter > ul > li:nth-child(7) > div > span::text').get()
#         product_chip = response.css('body > section.detail > div.box_main > div.box_right > div.parameter > ul > li:nth-child(5) > div > span::text').get()
#         product_screen = response.css('body > section.detail > div.box_main > div.box_right > div.parameter > ul > li:nth-child(1) > div > span.comma::text').get()
